...
if(isset($_GET['del'])){
    ...
    $data = array('model'=>'expenses', 'condition'=>" WHERE id = '".$_GET['del']."'");
    $response = $app->delete2($data);

    $data = array('model'=>'payments', 'condition'=>" WHERE model = 'expenses' AND model_id = '".$_GET['del']."'");
    $response = $app->delete2($data);
}


$conditions ="";
$data = array('model'=>'expenses', 'condition'=>$conditions,'order'=>' order by date DESC');
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div style="padding:7px; text-align: right;" class="pull-right">
                            ...
                            <a href="?page=expenses-create" type="submit" class="btn btn-success btn-sm">Create</a>
                            <?php endif; ?>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <?php $c=0; foreach ($expenses as $key => $value): $c++;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($_SESSION['acl']['expenses-view']==100): ?>    
                                        <a href="?page=expenses-view&id=<?php echo $value['id']; ?>">
                                            <button  class="btn btn-info btn-xs"><i class="fa fa-file-text-o"></i> View</button>
                                        </a>
                                    <?php endif; ?>
                                        <?php if($_SESSION['acl']['expenses-update']==1): ?>
                                        <a href="?page=expenses-create&id=<?php echo $value['id']; ?>">
                                       ...
                                       <!--  <button class="btn btn-danger btn-xs" id="<?php echo $value['id']; ?>" onclick="deleteThis(this.id)"><i class="fa fa-trash-o"></i> Delete</button>
                                        ...
                                        <?php endif; ?>
                                         ...
                                         <?php if($_SESSION['acl']['expenses-delete']==1): ?>
