...
if(isset($_GET['del'])){
    ...
    $data = array('model'=>'department', 'condition'=>" WHERE id = '".$_GET['del']."'");
    $response = $app->delete2($data);
}



$data = array('model'=>'department','order'=>' order by name');
$conditions ="";
...
$data = array('model'=>'department', 'condition'=>$conditions,'order'=>' order by name');
...
$data = array('model'=>'department', 'order'=>' order by name', 'condition'=>"",
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div style="padding:7px; text-align: right;" class="pull-right">
                            ...
                            <?php if($_SESSION['acl']['department-create']==1): ?>
                            <a href="?page=department-create" type="submit" class="btn btn-success btn-sm">Create</a>
                            <?php endif; ?>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <?php $c=0; foreach ($department as $key => $value): $c++;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($_SESSION['acl']['department-view']==1): ?>    
                                        <a href="?page=department-view&id=<?php echo $value['id']; ?>">
                                            <button  class="btn btn-info btn-xs"><i class="fa fa-file-text-o"></i> View</button>
                                        </a>
                                    <?php endif; ?>
                                        <?php if($_SESSION['acl']['department-update']==1): ?>
                                        <a href="?page=department-create&id=<?php echo $value['id']; ?>">
                                       ...
                                       <!--  <button class="btn btn-danger btn-xs" id="<?php echo $value['id']; ?>" onclick="deleteThis(this.id)"><i class="fa fa-trash-o"></i> Delete</button>
                                        ...
                                        <?php endif; ?>
                                         ...
                                         <?php if($_SESSION['acl']['department-delete']==1): ?>
