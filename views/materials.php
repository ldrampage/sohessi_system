...
if(isset($_GET['del'])){
    ...
    $data = array('model'=>'materials', 'condition'=>" WHERE id = '".$_GET['del']."'");
    $response = $app->delete2($data);
}



$data = array('model'=>'materials','order'=>' order by name');
$conditions ="";


$data = array('model'=>'materials', 'condition'=>$conditions,'order'=>' order by name');
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div style="padding:7px; text-align: right;" class="pull-right">
                            ...
                            <?php if($_SESSION['acl']['materials-create']==1): ?>
                            <a href="?page=materials-create" type="submit" class="btn btn-success btn-sm">Create</a>
                            <?php endif; ?>
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th style="width: 60%;">Reorder Level</th>
                            ...
                            <?php $c=0; foreach ($materials as $key => $value): $c++;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($_SESSION['acl']['materials-view']==100): ?>    
                                        <a href="?page=materials-view&id=<?php echo $value['id']; ?>">
                                            <button  class="btn btn-info btn-xs"><i class="fa fa-file-text-o"></i> View</button>
                                        </a>
                                    <?php endif; ?>
                                        <?php if($_SESSION['acl']['materials-update']==1): ?>
                                        <a href="?page=materials-create&id=<?php echo $value['id']; ?>">
