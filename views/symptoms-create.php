...
if(isset($_POST['btn_save'])){
    ...
    $data = array('model'=>"symptoms",'keys'=>"name, description");
...
if(isset($_GET['id'])){
    $action = "Update";
    $rqdata = array("model"=>"symptoms", "condition"=>" WHERE id = '".$_GET['id']."'");
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="pull-right" style="margin-top: -25px;">
                            <a href="?page=symptoms"><label class="btn btn-xs btn-info">Symptoms List</label></a> 
                        </div>
                    </div>
