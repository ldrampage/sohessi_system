...
$current = date("Y-m-d");
$sql = "SELECT * FROM tbl_queuing WHERE status='".PAID."' AND date = '".$current."' AND trans_type='Check-up' AND dr_id = '".$_SESSION['login_id']."' GROUP BY queuing_number  ORDER BY dtime ASC";
// $sql;
...
?>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4 col-xs-4">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <a href="index.php?page=tickets&status=0"><span class="info-box-text">Next<br>Payments</span></a>
 ...
 function chechEnqued(){
   $.ajax({
        ...
        type: "post",
        data: { en: 5, did: <?php echo $_SESSION['login_id']; ?> },
        success: function (response) {
          ...
          for (val in data) { counter++;
              ...
              stringHTML += "<td><a href='?page=consult&id="+data[val]['patient_id']+"&qn="+data[val]['queuing_number']+"' class='btn btn-xs btn-success'>Proceed</a></td>";
              stringHTML += "</tr>";
          }
