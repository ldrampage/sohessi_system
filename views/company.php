...
if(isset($_GET['del'])){
    ...
    $data = array('model'=>'company', 'condition'=>" WHERE id = '".$_GET['del']."'");
    $response = $app->delete2($data);
}



$data = array('model'=>'company','order'=>' order by company');
$conditions ="";


$data = array('model'=>'company', 'condition'=>$conditions,'order'=>' order by company');
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div style="padding:7px; text-align: right;" class="pull-right">
                            ...
                            <?php if($_SESSION['acl']['company-create']==1): ?>
                            <a href="?page=company-create" type="submit" class="btn btn-success btn-sm">Create</a>
                            <?php endif; ?>
                            ...
                            <?php $c=0; foreach ($materials as $key => $value): $c++;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="?page=company-view&id=<?php echo $value['id']; ?>">
                                            <button  class="btn btn-info btn-xs"><i class="fa fa-file-text-o"></i> View</button>
                                        </a>
                                    <?php endif; ?>
                                        <?php if($_SESSION['acl']['company-update']==1): ?>
                                        <a href="?page=company-create&id=<?php echo $value['id']; ?>">
                                       ...
                                       <!--  <button class="btn btn-danger btn-xs" id="<?php echo $value['id']; ?>" onclick="deleteThis(this.id)"><i class="fa fa-trash-o"></i> Delete</button>
                                        ...
                                        <?php endif; ?>
                                         ...
                                         <?php if($_SESSION['acl']['company-delete']==1): ?>
                                           ...
                                           <button  class="btn btn-danger btn-xs" onClick="deleteThis('<?php echo $value['id']; ?>','<?php echo $value['company']." ".$value['branch']; ?>')"><i class="fa fa-refresh"></i> Delete</button>
