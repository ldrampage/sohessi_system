...
if(isset($_POST['btn_save'])){
   ...
   //echo json_encode($_POST);
    $data = array('model'=>"paymentmethods",'keys'=>"name");
    if(isset($_POST['id'])){
...
if(isset($_GET['id'])){
    $action = "Update";
    $rqdata = array("model"=>"paymentmethods", "condition"=>" WHERE id = '".$_GET['id']."'"); 
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="pull-right" style="margin-top: -25px;">
                            <a href="?page=method"><label class="btn btn-xs btn-info">Payment Method List</label></a> 
                        </div>
                    </div>
