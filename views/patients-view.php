    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="pull-right" style="margin-top: -15px;">
                            <a href="?page=employee"><label class="btn btn-xs btn-info">Patiant List</label></a> 
            </div>
        </div>
        <!-- /.col -->
    </div>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="<?php if($tab=="lt"){ echo "active"; } ?>"><a href="?page=<?php echo $_GET['page']; ?>&id=<?php echo $_GET['id']; ?>&tab=lt" >Lab Tests</a></li>

              <li class="<?php if($tab=="pr"){ echo "active"; } ?>"><a href="?page=<?php echo $_GET['page']; ?>&id=<?php echo $_GET['id']; ?>&tab=pr" >Prescriptions</a></li>

              <li class="<?php if($tab=="vs"){ echo "active"; } ?>"><a href="?page=<?php echo $_GET['page']; ?>&id=<?php echo $_GET['id']; ?>&tab=vs" data-toggle="">Vital Signs</a></li>

              <li class="<?php if($tab=="ds"){ echo "active"; } ?>"><a href="?page=<?php echo $_GET['page']; ?>&id=<?php echo $_GET['id']; ?>&tab=ds" data-toggle="">Diseases</a></li>

              <li class="<?php if($tab=="op"){ echo "active"; } ?>"><a href="?page=<?php echo $_GET['page']; ?>&id=<?php echo $_GET['id']; ?>&tab=op" data-toggle="">Operations</a></li>
              ...
              <?php if($tab=="lt"){
                ...
                $labr = $app->getPatientResults("WHERE patient_id = '".$_GET['id']."' ORDER BY date DESC");
                $Labs = $app->getLabTests(); 
               ?>
              
              <div class="<?php if($tab=="lt"){ echo "active"; } ?> tab-pane" id="">
              <div class="row">
              <div class="col-md-12">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            $c=0; foreach ($labr as $key => $value): $c++;
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <label onClick="retrieveResult('<?php echo $value['id']; ?>')" class="btn btn-warning btn-xs">Check Details</a>
                                    </td>
