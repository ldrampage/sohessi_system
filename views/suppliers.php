...
if(isset($_GET['del'])){
    ...
    $data = array('model'=>'suppliers', 'condition'=>" WHERE id = '".$_GET['del']."'");
    $response = $app->delete2($data);
}



$data = array('model'=>'suppliers','order'=>' order by name');
$conditions ="";
...
$data = array('model'=>'suppliers', 'condition'=>$conditions,'order'=>' order by business');
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div style="padding:7px; text-align: right;" class="pull-right">
                            ...
                            <?php if($_SESSION['acl']['suppliers-create']==1): ?>
                            <a href="?page=suppliers-create" type="submit" class="btn btn-success btn-sm">Create</a>
                            <?php endif; ?>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <?php $c=0; foreach ($department as $key => $value): $c++;
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $value['phone']."/".$value['mobile']; ?></td>
                                    <td><?php echo $value['email']; ?></td>
                                  
                                    <td>
                                        <?php if($_SESSION['acl']['suppliers-view']==1): ?>    
                                        <a href="?page=suppliers-view&id=<?php echo $value['id']; ?>">
                                            <button  class="btn btn-info btn-xs"><i class="fa fa-file-text-o"></i> View</button>
                                        </a>
                                    <?php endif; ?>
                                        <?php if($_SESSION['acl']['suppliers-update']==1): ?>
                                        <a href="?page=suppliers-create&id=<?php echo $value['id']; ?>">
                                       ...
                                       <!--  <button class="btn btn-danger btn-xs" id="<?php echo $value['id']; ?>" onclick="deleteThis(this.id)"><i class="fa fa-trash-o"></i> Delete</button>
                                        ...
                                        <?php endif; ?>
                                         ...
                                         <?php if($_SESSION['acl']['suppliers-delete']==1): ?>
                                           ...
                                           <button  class="btn btn-danger btn-xs" onClick="deleteThis('<?php echo $value['id']; ?>','<?php echo $value['business']; ?>')"><i class="fa fa-refresh"></i> Delete</button>
