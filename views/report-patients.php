                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="form-group">
                                    <label for="inputSkills" class="col-sm-12 control-label"><h3 class="box-title" style="font-weight: bold;     line-height: 1.5;">Patient <?php echo $title; ?></h3></label>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td ><?php echo date('F d, Y', strtotime($value['bdate'])); ?></td>
                                    <td> <?php
