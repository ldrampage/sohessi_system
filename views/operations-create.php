...
if(isset($_POST['btn_save'])){
    ...
    $data = array('model'=>"operations",'keys'=>"name, description");
...
if(isset($_GET['id'])){
    $action = "Update";
    $rqdata = array("model"=>"operations", "condition"=>" WHERE id = '".$_GET['id']."'");
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="pull-right" style="margin-top: -25px;">
                            <a href="?page=operations"><label class="btn btn-xs btn-info">Operation List</label></a> 
                        </div>
                    </div>
