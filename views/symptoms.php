...
if(isset($_GET['del'])){
    ...
    $data = array('model'=>'symptoms', 'condition'=>" WHERE id = '".$_GET['del']."'");
    $response = $app->delete2($data);
}



$data = array('model'=>'symptoms','order'=>' order by name');
$conditions ="";


$data = array('model'=>'symptoms', 'condition'=>$conditions,'order'=>' order by name');
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div style="padding:7px; text-align: right;" class="pull-right">
                            ...
                            <?php if($_SESSION['acl']['symptoms-create']==1): ?>
                            <a href="?page=symptoms-create" type="submit" class="btn btn-success btn-sm">Create</a>
                            <?php endif; ?>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <?php $c=0; foreach ($materials as $key => $value): $c++;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($_SESSION['acl']['symptoms-view']==100): ?>    
                                        <a href="?page=symptoms-view&id=<?php echo $value['id']; ?>">
                                            <button  class="btn btn-info btn-xs"><i class="fa fa-file-text-o"></i> View</button>
                                        </a>
                                    <?php endif; ?>
                                        <?php if($_SESSION['acl']['symptoms-update']==1): ?>
                                        <a href="?page=symptoms-create&id=<?php echo $value['id']; ?>">
