        ...
        var onKeypress = function(e) {
            ...
            switch (keyContent) {
                ...
                case 'enter':
                    ...
                    break;
                // case 'tab':
                //     //parent.closest('input').tabs("option","active");
                //     var current_tabindex = parseInt(parent.closest('input').attr("tabindex"));
                //     var next = current_tabindex + 1;
                //     if(next>=14){ next = 1; }
                //    //alert(next);
                //     //$('[tabindex=' + next + ']').focus();
                //     $('*').attr('tabindex', next).focus();
                //     //alert(parent.closest('input').attr("tabindex"));
                //     break;    
                default:
